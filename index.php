<?php
	...
	$ignore_file_list = array( ".htaccess", "Thumbs.db", ".DS_Store", "index.php","islem.php","php_error.log");
...
<html>
<head>
	<title>Folder Management System on PHP </title>
	<meta charset="utf-8">
...
<div style="padding: 10px 10px 40px 10px;" id="bir"><a href="https://www.devialt.com"><img src="https://devialt.com/en/images/devialt-logo.png" style="width: 100px;"></a> </div>


<div style="padding: 10px 10px 40px 10px;display:none;" id="iki"><img src="https://cdn-icons-png.flaticon.com/512/1710/1710008.png" style="width: 50px;"><br><p style="color:green">Basirili bir sekilde tamamlandi.</p>
</div>
</div>

<button id="btn1" class="btn btn-primary">Process</button>



<div class="wrap2" style="display:none" class="form-group" align="center">
			...
			<br><br><button id="btn2" class="btn btn-outline-primary" style="display:none;">Back</button>
...
<br><br><p><b>1)</b> Buraya hangi klasöre islem yapmak istiyorsak onun adını yazacağız.</p>
<p><b>2)</b> Kopyalamak istediğimiz belgeler , olusturulacak olan yeni klasörde listelenir.</p>
<p><b>3)</b> Bu kısma ise kopyalamak istediğimiz dosyanın başlangıç karakterini yazarız Örn : a,a1,a1_ gibi</p>
...
function dosyakopyala()
{

if (copy("klasor/a1_kasa.pdf", "yeni-bilisimcafe.pdf")) {
